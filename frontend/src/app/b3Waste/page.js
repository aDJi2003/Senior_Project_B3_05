...
const steps = [
  {
    step: "Toxic",
    desc: "Contains poisonous substances that can cause harm if ingested, inhaled, or absorbed by the skin (e.g., pesticides, lead batteries).",
  },
  {
    step: "Flammable",
    desc: "Easily catches fire, posing a fire or explosion risk (e.g., gasoline, alcohol, solvents).",
  },
  {
    step: "Corrosive",
    desc: "Can cause damage to living tissues or materials (e.g., acids, strong bases, bleach).",
  },
  {
    step: "Reactive",
    desc: "Can undergo dangerous chemical reactions when exposed to other substances (e.g., lithium batteries, ammonia).",
  },
  {
    step: "Infectious",
    desc: "Contains harmful biological agents like bacteria or viruses (e.g., medical waste, used syringes).",
  },
];
...
const Section = ({ title, children }) => (
  <div className="flex flex-col gap-3 mb-10">
    <h2 className="text-green-700 text-3xl font-semibold border-l-4 border-green-700 pl-3">
      {title}
    </h2>
    {children}
  </div>
      ...
      <div className="min-h-screen flex flex-col bg-gray-50 font-poppins">
        ...
        <div className="flex flex-col mt-[12vh] mx-auto max-w-5xl p-6">
          <div className="flex items-center justify-between mb-8">
            ...
            >
              <FaAngleLeft className="mr-1" /> Organic Waste
            </span>
            ...
            >
              Inorganic Waste <FaAngleRight className="ml-1" />
            </span>
          </div>
          ...
          <Section title="B3 Waste (Hazardous and Toxic Waste) Overview">
            <p className="text-gray-700 text-lg leading-relaxed bg-white p-4 shadow-md rounded-lg">
              B3 waste, or Hazardous and Toxic Waste, refers to waste materials
              that{" "}
              <span className="text-green-500">
                contain substances that can be harmful to humans, animals, and
                the environment.
              </span>{" "}
              These materials require special handling and disposal methods to
              prevent pollution and health hazards.
            </p>
          </Section>
          ...
          <Section title="Characteristics of B3 Waste:">
            <div className="grid md:grid-cols-2 gap-6">
              {steps.map((item, index) => (
                <div
                  key={index}
                  className="p-4 shadow-lg border-l-4 border-green-500 rounded bg-white"
                >
          ...
          <div className="bg-green-100 p-6 rounded-lg text-center shadow-md">
            ...
            <p className="text-gray-700 mb-4">
              Use apps like <span className="font-bold">Trashify</span> to
              identify hazardous waste and guide users on proper disposal
              methods!
            </p>
          </div>
        </div>
