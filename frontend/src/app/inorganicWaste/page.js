...
const images = [
  "/inorganic_waste.png",
  "/inorganic_waste_1.jpg",
  "/inorganic_waste_2.jpg",
];

const steps = [
  {
    step: "Separate waste",
    desc: "based on material (plastic, metal, glass).",
  },
  {
    step: "Clean and dry",
    desc: "plastic, glass, and metal before recycling.",
  },
  {
    step: "Reuse items",
    desc: "such as plastic bottles and glass jars whenever possible.",
  },
  {
    step: "Bring recyclables to proper facilities",
    desc: "or use designated recycling bins.",
  },
  {
    step: "Dispose of hazardous inorganic waste",
    desc: "at specialized collection centers.",
  },
];
        ...
        <div className="flex flex-col mt-[12vh] mx-auto max-w-5xl p-6">
          ...
          <Section title="What is Inorganic Waste?">
            <p className="text-gray-700 text-lg leading-relaxed bg-white p-4 shadow-md rounded-lg">
              Inorganic waste consists of materials that do not decompose easily
              or naturally, such as{" "}
              <span className="font-semibold text-green-500">
                plastic, glass, metal, and electronic waste
              </span>
              . These materials take hundreds to thousands of years to break
          ...
          <div className="bg-green-100 p-6 rounded-lg text-center shadow-md">
            ...
            <p className="text-gray-700 mb-4">
              ...
              classify inorganic waste and find the best recycling or disposal
              methods to reduce pollution and promote sustainability!
            </p>
          </div>
        </div>
