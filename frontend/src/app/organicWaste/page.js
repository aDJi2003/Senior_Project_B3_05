...
const steps = [
  {
    step: "Separate organic waste",
    desc: "from non-biodegradable materials like plastic or metal.",
  },
  {
    step: "Compost at home",
    desc: "by using a compost bin or pile in your garden.",
  },
  {
    step: "Use composting techniques",
    desc: "such as vermicomposting (using worms) or aerobic composting.",
  },
  {
    step: "Turn organic waste into fertilizer",
    desc: "to improve soil quality for plants.",
  },
  {
    step: "Dispose of organic waste properly",
    desc: "if composting is not possible—some cities offer organic waste collection services.",
  },
];
...
const Section = ({ title, children }) => (
  <div className="flex flex-col gap-3 mb-10">
    <h2 className="text-green-700 text-3xl font-semibold border-l-4 border-green-600 pl-3">
      {title}
    </h2>
    {children}
  </div>
        ...
        <div className="flex flex-col mt-[12vh] mx-auto max-w-5xl p-6">
          ...
          <Section title="What is Organic Waste?">
            <p className="text-gray-700 text-lg leading-relaxed bg-white p-4 shadow-md rounded-lg">
              Organic waste includes biodegradable materials such as{" "}
              <span className="text-green-500">
                food scraps, garden waste, and other natural materials{" "}
              </span>
          ...
          <div className="bg-green-100 p-6 rounded-lg text-center shadow-md">
            ...
            <p className="text-gray-700 mb-4">
              ...
              identify organic waste and learn how to compost or dispose of it
              properly for a more sustainable environment!
            </p>
          </div>
        </div>
